...
"""Reference resnet.BasicBlock and resnet.Bottleneck instead
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.relu = nn.ReLU( inplace=True )  # original model
...
def resnet50(pretrained=False, num_classes=1000, bn0=False, **kwargs):
